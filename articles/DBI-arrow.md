...
[`dbReadTable()`](https://dbi.r-dbi.org/reference/dbReadTable.md). Arrow
...
fetch the result. This also allows using the new
[`dbBindArrow()`](https://dbi.r-dbi.org/reference/dbBind.md) method to
bind data in Arrow format to a prepared query. Result objects must be
cleared with
