...
[`dbDataType()`](https://dbi.r-dbi.org/reference/dbDataType.md) returns
the SQL type that corresponds to the `obj` argument as a non-empty
character string. For data frames, a character vector with one element
per column is returned.
...
[`dbDataType()`](https://dbi.r-dbi.org/reference/dbDataType.md) generic
...
[`dbDataType()`](https://dbi.r-dbi.org/reference/dbDataType.md) are
...
details. Use
[`dbCanConnect()`](https://dbi.r-dbi.org/reference/dbCanConnect.md) to
...
[`dbConnect()`](https://dbi.r-dbi.org/reference/dbConnect.md) returns an
S4 object that inherits from DBIConnection. This object is used to
...
|        |                                                                                                       |
|--------|-------------------------------------------------------------------------------------------------------|
| `conn` | A DBIConnection object, as returned by [`dbConnect()`](https://dbi.r-dbi.org/reference/dbConnect.md). |
...
[`dbDisconnect()`](https://dbi.r-dbi.org/reference/dbDisconnect.md), but
this cannot be tested automatically. At least one warning is issued
immediately when calling
[`dbDisconnect()`](https://dbi.r-dbi.org/reference/dbDisconnect.md) on
an already disconnected or invalid connection.
...
The [`dbSendQuery()`](https://dbi.r-dbi.org/reference/dbSendQuery.md)
...
to use the [`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md)
...
[`dbGetQuery()`](https://dbi.r-dbi.org/reference/dbGetQuery.md). Use
...
[`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md) for details.
...
used with [`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) to
...
[`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md) or
[`dbBindArrow()`](https://dbi.r-dbi.org/reference/dbBind.md), is
implemented by
[`dbGetQuery()`](https://dbi.r-dbi.org/reference/dbGetQuery.md), which
should be sufficient unless you want to access the results in a paged
way or you have a parameterized query that you want to reuse. This flow
requires an active connection established by
[`dbConnect()`](https://dbi.r-dbi.org/reference/dbConnect.md). See also
`vignette("dbi-advanced")` for a walkthrough.

1.  Use
    [`dbSendQuery()`](https://dbi.r-dbi.org/reference/dbSendQuery.md) to
    create a result set object of class DBIResult.

2.  Optionally, bind query parameters with
    [`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md) or
    [`dbBindArrow()`](https://dbi.r-dbi.org/reference/dbBind.md). This
    is required only if the query contains placeholders such as `⁠?⁠` or
...
4.  Use [`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) to get
    the entire result set, a page of results, or the remaining rows.
...
|       |                                                                                                                                                                      |
|-------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `res` | An object inheriting from DBIResult, created by [`dbSendQuery()`](https://dbi.r-dbi.org/reference/dbSendQuery.md).                                                   |
...
[`fetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) is provided for
compatibility with older DBI clients - for all new code you are strongly
encouraged to use
[`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md). The default
implementation for
[`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) calls
[`fetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) so that it is
compatible with existing code. Modern backends should implement for
[`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) only.

### Value

[`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) always returns
a data.frame with as many rows as records were fetched and as many
columns as fields in the result set, even if the result is a single
...
[`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) with proper
`n` argument succeeds.

Calling [`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) on a
result set from a data manipulation query created by
[`dbSendStatement()`](https://dbi.r-dbi.org/reference/dbSendStatement.md)
...
[`dbSendQuery()`](https://dbi.r-dbi.org/reference/dbSendQuery.md) or
[`dbSendStatement()`](https://dbi.r-dbi.org/reference/dbSendStatement.md).
...
[`dbBindArrow()`](https://dbi.r-dbi.org/reference/dbBind.md), is
implemented by
[`dbExecute()`](https://dbi.r-dbi.org/reference/dbExecute.md), which
...
2.  Optionally, bind query parameters
    with[`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md) or
    [`dbBindArrow()`](https://dbi.r-dbi.org/reference/dbBind.md). This
    is required only if the query contains placeholders such as `⁠?⁠` or
    `⁠\$1⁠`, depending on the database backend.
...
values. The [`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md) and
[`dbBindArrow()`](https://dbi.r-dbi.org/reference/dbBind.md) functions
bind these placeholders to actual values, and are intended to be called
on the result set before calling
[`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) or
[`dbFetchArrow()`](https://dbi.r-dbi.org/reference/dbFetchArrow.md). The
values are passed to
[`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md) as lists or data
frames, and to
[`dbBindArrow()`](https://dbi.r-dbi.org/reference/dbBind.md) as a stream
created by
...
[`dbSendQuery()`](https://dbi.r-dbi.org/reference/dbSendQuery.md) is
compatible with
[`dbBindArrow()`](https://dbi.r-dbi.org/reference/dbBind.md), and
[`dbSendQueryArrow()`](https://dbi.r-dbi.org/reference/dbSendQueryArrow.md)
is compatible with
[`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md).
...
|----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `res`    | An object inheriting from DBIResult.                                                                                                                                                                                                                                                                |
| `params` | For [`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md), a list of values, named or unnamed, or a data frame, with one element/column per query parameter. For [`dbBindArrow()`](https://dbi.r-dbi.org/reference/dbBind.md), values as a nanoarrow stream, with one column per query parameter. |
| `...`    | Other arguments passed on to methods.                                                                                                                                                                                                                                                               |

### Details

DBI supports parametrized (or prepared) queries and statements via the
[`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md) and
[`dbBindArrow()`](https://dbi.r-dbi.org/reference/dbBind.md) generics.
...
[`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md) returns the
...
Most of this flow, except repeated calling of
[`dbBindArrow()`](https://dbi.r-dbi.org/reference/dbBind.md) or
[`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md), is implemented
by
[`dbGetQueryArrow()`](https://dbi.r-dbi.org/reference/dbGetQueryArrow.md),
...
by [`dbConnect()`](https://dbi.r-dbi.org/reference/dbConnect.md). See
...
2.  Optionally, bind query parameters with
    [`dbBindArrow()`](https://dbi.r-dbi.org/reference/dbBind.md) or
    [`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md). This is
...
Calling [`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md) for a
query without parameters raises an error.
...
Calling [`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md) on a
...
1.  Call
    ...
    [`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md) or
    [`dbBindArrow()`](https://dbi.r-dbi.org/reference/dbBind.md) have
    been called, the returned result set object has the following
    behavior:

    - [`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) raises
      an error (for
      [`dbSendQuery()`](https://dbi.r-dbi.org/reference/dbSendQuery.md)
      and
      [`dbSendQueryArrow()`](https://dbi.r-dbi.org/reference/dbSendQueryArrow.md))
...
2.  Call [`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md) or
    [`dbBindArrow()`](https://dbi.r-dbi.org/reference/dbBind.md):

    - For [`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md), the
      `params` argument must be a list where all elements have the same
      lengths and contain values supported by the backend. A data.frame
      is internally stored as such a list.

    - For [`dbBindArrow()`](https://dbi.r-dbi.org/reference/dbBind.md),
...
3.  Retrieve the data or the number of affected rows from the
    ...
    - For queries issued by
      ...
      or
      [`dbSendQueryArrow()`](https://dbi.r-dbi.org/reference/dbSendQueryArrow.md),
      call [`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md).

    - For statements issued by `dbSendStatements()`, call
      [`dbGetRowsAffected()`](https://dbi.r-dbi.org/reference/dbGetRowsAffected.md).
      (Execution begins immediately after the
      [`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md) call, the
...
calling [`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md)
...
parameters. [`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md) also
...
[`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md), for both
...
[`dbGetQuery()`](https://dbi.r-dbi.org/reference/dbGetQuery.md) comes
with a default implementation (which should work with most backends)
that calls
[`dbSendQuery()`](https://dbi.r-dbi.org/reference/dbSendQuery.md), then
[`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md), ensuring that
the result is always freed by
[`dbClearResult()`](https://dbi.r-dbi.org/reference/dbClearResult.md).
For retrieving chunked/paged results or for passing query parameters,
see [`dbSendQuery()`](https://dbi.r-dbi.org/reference/dbSendQuery.md),
...
The following arguments are not part of the
[`dbGetQuery()`](https://dbi.r-dbi.org/reference/dbGetQuery.md) generic
...
to use [`dbExecute()`](https://dbi.r-dbi.org/reference/dbExecute.md) for
data manipulation statements.

### Value

[`dbGetQuery()`](https://dbi.r-dbi.org/reference/dbGetQuery.md) always
...
to [`dbGetQuery()`](https://dbi.r-dbi.org/reference/dbGetQuery.md) with
...
[`dbExecute()`](https://dbi.r-dbi.org/reference/dbExecute.md) comes with
...
[`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md), in particular
...
The following arguments are not part of the
[`dbExecute()`](https://dbi.r-dbi.org/reference/dbExecute.md) generic
(to improve compatibility across backends) but are part of the DBI
specification:
...
You can also use
[`dbExecute()`](https://dbi.r-dbi.org/reference/dbExecute.md) to call a
stored procedure that performs data manipulation or other actions that
do not return a result set. To execute a stored procedure that returns a
result set, or a data manipulation query that also returns a result set
such as `⁠INSERT INTO ... RETURNING ...⁠`, use
[`dbGetQuery()`](https://dbi.r-dbi.org/reference/dbGetQuery.md) instead.

### Value

[`dbExecute()`](https://dbi.r-dbi.org/reference/dbExecute.md) always
...
[`dbQuoteString()`](https://dbi.r-dbi.org/reference/dbQuoteString.md) as
`x` argument, it is returned unchanged. Passing objects of class SQL
...
Calling [`dbGetQuery()`](https://dbi.r-dbi.org/reference/dbGetQuery.md)
...
[`SQL()`](https://dbi.r-dbi.org/reference/SQL.md) and then quoting via
[`dbQuoteIdentifier()`](https://dbi.r-dbi.org/reference/dbQuoteIdentifier.md)
...
- If an unquoted table name as string:
  [`dbReadTable()`](https://dbi.r-dbi.org/reference/dbReadTable.md) will
  do the quoting, perhaps by calling `dbQuoteIdentifier(conn, x = name)`
...
[`dbGetQuery()`](https://dbi.r-dbi.org/reference/dbGetQuery.md) with
`⁠SELECT * FROM <name>⁠`.
...
same time. Use
[`dbAppendTable()`](https://dbi.r-dbi.org/reference/dbAppendTable.md) or
[`dbAppendTableArrow()`](https://dbi.r-dbi.org/reference/dbAppendTableArrow.md)
for appending data to an existing table,
[`dbCreateTable()`](https://dbi.r-dbi.org/reference/dbCreateTable.md) or
...
and [`dbExecute()`](https://dbi.r-dbi.org/reference/dbExecute.md). Use
[`dbCreateTableArrow()`](https://dbi.r-dbi.org/reference/dbCreateTableArrow.md)
...
and then [`dbExecute()`](https://dbi.r-dbi.org/reference/dbExecute.md)
with the `param` argument. Use
[`dbAppendTableArrow()`](https://dbi.r-dbi.org/reference/dbAppendTableArrow.md)
...
[`dbListTables()`](https://dbi.r-dbi.org/reference/dbListTables.md), and
[`dbExistsTable()`](https://dbi.r-dbi.org/reference/dbExistsTable.md)
...
[`dbWriteTable()`](https://dbi.r-dbi.org/reference/dbWriteTable.md) are
part of the list. As soon a table is removed from the database, it is
also removed from the list of database tables.
...
|----------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `conn`   | A DBIConnection object, as returned by [`dbConnect()`](https://dbi.r-dbi.org/reference/dbConnect.md).                                                                                                                                                              |
| `prefix` | A fully qualified path in the database’s namespace, or `NULL`. This argument will be processed with [`dbUnquoteIdentifier()`](https://dbi.r-dbi.org/reference/dbUnquoteIdentifier.md). If given the method will return all objects accessible through this prefix. |
| `...`    | Other parameters passed on to methods.                                                                                                                                                                                                                             |
...
added with
[`dbWriteTable()`](https://dbi.r-dbi.org/reference/dbWriteTable.md) are
part of the data frame. As soon a table is removed from the database, it
is also removed from the data frame of database objects.
...
[`dbIsValid()`](https://dbi.r-dbi.org/reference/dbIsValid.md) returns a
logical scalar, `TRUE` if the object specified by `dbObj` is valid,
`FALSE` otherwise. A DBIConnection object is initially valid, and
becomes invalid after disconnecting with
[`dbDisconnect()`](https://dbi.r-dbi.org/reference/dbDisconnect.md). For
an invalid connection object (e.g., for some drivers if the object is
saved to a file and then restored), the method also returns `FALSE`. A
DBIResult object is valid after a call to
[`dbSendQuery()`](https://dbi.r-dbi.org/reference/dbSendQuery.md), and
...
[`dbIsValid()`](https://dbi.r-dbi.org/reference/dbIsValid.md) should
...
[`dbSendQuery()`](https://dbi.r-dbi.org/reference/dbSendQuery.md) with
non-empty result set,
[`dbHasCompleted()`](https://dbi.r-dbi.org/reference/dbHasCompleted.md)
returns `FALSE` initially and `TRUE` after calling
[`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) without limit.
For a query initiated by
[`dbSendStatement()`](https://dbi.r-dbi.org/reference/dbSendStatement.md),
[`dbHasCompleted()`](https://dbi.r-dbi.org/reference/dbHasCompleted.md)
always returns `TRUE`.
...
[`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) for this
result set.
...
[`dbSendQuery()`](https://dbi.r-dbi.org/reference/dbSendQuery.md), the
row count is initially zero. After a call to
[`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) without limit,
the row count matches the total number of rows returned. Fetching a
limited number of rows increases the number of rows by the number of
...
[`dbSendQuery()`](https://dbi.r-dbi.org/reference/dbSendQuery.md), zero
is returned before and after the call to
[`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md). `NA` values
are not allowed.
...
[`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md). The `"type"`
column is of type `character` and only for information. Do not compute
on the `"type"` column, instead use `dbFetch(res, n = 0)` to create a
zero-row data frame initialized with the correct data types.
...
is initiated with
[`dbBegin()`](https://dbi.r-dbi.org/reference/transactions.md) and
either made persistent with
[`dbCommit()`](https://dbi.r-dbi.org/reference/transactions.md) or
undone with
[`dbRollback()`](https://dbi.r-dbi.org/reference/transactions.md). In
any case, the DBMS guarantees that either all or none of the statements
have a permanent effect. This helps ensuring consistency of write
...
[`dbCommit()`](https://dbi.r-dbi.org/reference/transactions.md) and
[`dbRollback()`](https://dbi.r-dbi.org/reference/transactions.md) return
`TRUE`, invisibly.
...
[`dbBegin()`](https://dbi.r-dbi.org/reference/transactions.md) raises an
error. Nested transactions are not supported by DBI, an attempt to call
[`dbBegin()`](https://dbi.r-dbi.org/reference/transactions.md) twice
yields an error.
...
[`dbCommit()`](https://dbi.r-dbi.org/reference/transactions.md). Data
written in a transaction must persist after the transaction is
...
[`dbRollback()`](https://dbi.r-dbi.org/reference/transactions.md). All
...
calls [`dbBegin()`](https://dbi.r-dbi.org/reference/transactions.md)
before executing the code, and
[`dbCommit()`](https://dbi.r-dbi.org/reference/transactions.md) after
successful completion, or
[`dbRollback()`](https://dbi.r-dbi.org/reference/transactions.md) in
case of an error. The advantage is that you don’t have to remember to do
[`dbBegin()`](https://dbi.r-dbi.org/reference/transactions.md) and
[`dbCommit()`](https://dbi.r-dbi.org/reference/transactions.md) or
[`dbRollback()`](https://dbi.r-dbi.org/reference/transactions.md) – that
is all taken care of. The special function
...
or invalid or if
[`dbBegin()`](https://dbi.r-dbi.org/reference/transactions.md) has been
called already) gives an error.

### Specification

[`dbWithTransaction()`](https://dbi.r-dbi.org/reference/dbWithTransaction.md)
initiates a transaction with
[`dbBegin()`](https://dbi.r-dbi.org/reference/transactions.md), executes
the code given in the `code` argument, and commits the transaction with
[`dbCommit()`](https://dbi.r-dbi.org/reference/transactions.md). If the
code raises an error, the transaction is instead aborted with
[`dbRollback()`](https://dbi.r-dbi.org/reference/transactions.md), and
the error is propagated. If the code calls
[`dbBreak()`](https://dbi.r-dbi.org/reference/dbWithTransaction.md),
...
[`dbGetInfo()`](https://dbi.r-dbi.org/reference/dbGetInfo.md) returns a
...
- `statatment`: the statement used with
  [`dbSendQuery()`](https://dbi.r-dbi.org/reference/dbSendQuery.md) or
  [`dbExecute()`](https://dbi.r-dbi.org/reference/dbExecute.md), as
  returned by
  [`dbGetStatement()`](https://dbi.r-dbi.org/reference/dbGetStatement.md),
...
should almost always prefer
[`dbGetQueryArrow()`](https://dbi.r-dbi.org/reference/dbGetQueryArrow.md).
Use [`dbSendQuery()`](https://dbi.r-dbi.org/reference/dbSendQuery.md) or
[`dbGetQuery()`](https://dbi.r-dbi.org/reference/dbGetQuery.md) instead
...
can be used with
[`dbFetchArrow()`](https://dbi.r-dbi.org/reference/dbFetchArrow.md) to
extract records. Once you have finished using a result, make sure to
clear it with
[`dbClearResult()`](https://dbi.r-dbi.org/reference/dbClearResult.md).
...
|       |                                                                                                                                   |
|-------|-----------------------------------------------------------------------------------------------------------------------------------|
| `res` | An object inheriting from DBIResultArrow, created by [`dbSendQueryArrow()`](https://dbi.r-dbi.org/reference/dbSendQueryArrow.md). |
| `...` | Other arguments passed on to methods.                                                                                             |
...
[`dbFetchArrow()`](https://dbi.r-dbi.org/reference/dbFetchArrow.md) can
also be passed to
[`nanoarrow::as_nanoarrow_array_stream()`](https://arrow.apache.org/nanoarrow/latest/r/reference/as_nanoarrow_array_stream.html)
...
[`dbExecute()`](https://dbi.r-dbi.org/reference/dbExecute.md) for data
...
[`dbReadTable()`](https://dbi.r-dbi.org/reference/dbReadTable.md) to
obtain a data frame.
...
[`nanoarrow::as_nanoarrow_array_stream()`](https://arrow.apache.org/nanoarrow/latest/r/reference/as_nanoarrow_array_stream.html)
or use
[`dbWriteTable()`](https://dbi.r-dbi.org/reference/dbWriteTable.md) to
write a data frame.
...
[`dbCreateTable()`](https://dbi.r-dbi.org/reference/dbCreateTable.md) to
create a table from the column types as defined in a data frame.
...
[`dbAppendTable()`](https://dbi.r-dbi.org/reference/dbAppendTable.md) to
