...
#' for compatibility reasons.  However, callers are strongly advised to use [dbExecute()] for data manipulation statements.
#'
#' @template methods
...
#'
#' @param conn A [DBI::DBIConnection][DBIConnection-class] object, as returned by [dbConnect()].
