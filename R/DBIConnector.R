...
#' The purpose of this class is to store both the driver and the connection options.
#' A database connection can be established with a call to [dbConnect()],
...
#' In such a case, the function is evaluated transparently when connecting in [dbGetConnectArgs()].
#'
# FIXME: Include this
# Database backends can take advantage of this feature by returning an instance of this class instead of `DBIDriver`.
