...
#' The output will vary a little from method to method
#' depending on whether the main upload device is through a single SQL string or multiple parameterized queries.
