...
#' DBIResult class
#'
#' This virtual class describes the result and state of execution of a DBMS statement
#' (any statement, query or non-query).  The result set keeps track of whether the statement produces output
