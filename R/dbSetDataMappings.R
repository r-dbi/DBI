...
#'
#' Sets one or more conversion functions to handle the translation of DBMS data types to R objects.  This is only needed
#' for non-primitive data, since all DBI drivers handle the common base types (integers, numeric, strings, etc.)
#'
