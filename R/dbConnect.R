...
#'   or an existing [DBI::DBIConnection][DBIConnection-class] object (in order to clone an existing connection).
#' @param ... Authentication arguments needed by the DBMS instance;
#'   these typically include `user`, `password`, `host`, `port`, `dbname`, etc.
