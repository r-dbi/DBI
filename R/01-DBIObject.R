...
#' and `DBIResult` that represent the result of a DBMS statement.
#' These three classes extend the basic class of `DBIObject`, which serves as the root or parent of the class hierarchy.
#'
...
#'     The default method invokes `dbGetInfo(dbObj)` and prints the name-value pairs one per line.
