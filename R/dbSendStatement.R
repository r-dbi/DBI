...
#' (e.g., `UPDATE`, `DELETE`, `INSERT INTO`, `DROP TABLE`, ...) to the database engine.
#' To query the number of affected rows, call [dbGetRowsAffected()] on the returned result object.
#' You must also call [dbClearResult()] after that.
