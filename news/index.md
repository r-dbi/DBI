...
- [`dbWithTransaction()`](https://dbi.r-dbi.org/reference/dbWithTransaction.md)
  calls
  [`dbRollback()`](https://dbi.r-dbi.org/reference/transactions.md) also
  on interrupt ([@klin333](https://github.com/klin333),
...
- Include [`dbGetInfo()`](https://dbi.r-dbi.org/reference/dbGetInfo.md)
  in the spec ([\#477](https://github.com/r-dbi/DBI/issues/477)).
...
- [`Id()`](https://dbi.r-dbi.org/reference/Id.md) does not assign empty
  names to the components if all arguments are unnamed
...
- [`dbUnquoteIdentifier()`](https://dbi.r-dbi.org/reference/dbUnquoteIdentifier.md)
  creates [`Id()`](https://dbi.r-dbi.org/reference/Id.md) objects
...
- [`Id()`](https://dbi.r-dbi.org/reference/Id.md) now accepts unnamed
  components ([\#417](https://github.com/r-dbi/DBI/issues/417)). If
  names are provided, the components are arranged in SQL order
  ([@eauleaf](https://github.com/eauleaf),
  [\#427](https://github.com/r-dbi/DBI/issues/427)).

- New [`dbIsValid()`](https://dbi.r-dbi.org/reference/dbIsValid.md)
...
- [`?dbSendQuery`](https://dbi.r-dbi.org/reference/dbSendQuery.md) and
  related methods gain a section “The data retrieval flow”
...
- Use
  ...
  [`sqlData()`](https://dbi.r-dbi.org/reference/sqlData.md)
...
- The pkgdown documentation for DBI generics
  (e.g. [`?dbConnect`](https://dbi.r-dbi.org/reference/dbConnect.md))
  contains clickable links to all known backends (except ROracle), and
  an explanatory sentence
  ([\#360](https://github.com/r-dbi/DBI/issues/360)).
- [`?Id`](https://dbi.r-dbi.org/reference/Id.md) gains better examples
  ([\#295](https://github.com/r-dbi/DBI/issues/295),
  [\#370](https://github.com/r-dbi/DBI/issues/370)).
- Elaborate on status of
  [`dbWriteTable()`](https://dbi.r-dbi.org/reference/dbWriteTable.md) in
  the documentation ([\#352](https://github.com/r-dbi/DBI/issues/352),
...
- [`?dbReadTable`](https://dbi.r-dbi.org/reference/dbReadTable.md) and
  other pages gain pointers to
  [`Id()`](https://dbi.r-dbi.org/reference/Id.md) and
  [`SQL()`](https://dbi.r-dbi.org/reference/SQL.md)
...
- Specify `immediate` argument to
  ...
  [`dbSendStatement()`](https://dbi.r-dbi.org/reference/dbSendStatement.md)
  and [`dbExecute()`](https://dbi.r-dbi.org/reference/dbExecute.md)
...
- [`dbUnquoteIdentifier()`](https://dbi.r-dbi.org/reference/dbUnquoteIdentifier.md)
  now supports [`Id()`](https://dbi.r-dbi.org/reference/Id.md) objects
  with `catalog` members
...
- Improved documentation for
  ...
  [`SQL()`](https://dbi.r-dbi.org/reference/SQL.md) to
  [`sqlInterpolate()`](https://dbi.r-dbi.org/reference/sqlInterpolate.md)
...
- New
  ...
  with a `param` argument, without support for `row.names` argument
...
- New
  ...
  and then
  [`dbExecute()`](https://dbi.r-dbi.org/reference/dbExecute.md), without
  support for `row.names` argument
  ([\#74](https://github.com/r-dbi/DBI/issues/74)).
- New
...
- Add “Additional arguments” sections and more examples for
  [`dbGetQuery()`](https://dbi.r-dbi.org/reference/dbGetQuery.md),
  [`dbSendQuery()`](https://dbi.r-dbi.org/reference/dbSendQuery.md),
  [`dbExecute()`](https://dbi.r-dbi.org/reference/dbExecute.md) and
  [`dbSendStatement()`](https://dbi.r-dbi.org/reference/dbSendStatement.md).
- The
...
- [`SQL()`](https://dbi.r-dbi.org/reference/SQL.md) now strips the names
  from the output if the `names` argument is unset.
- The [`dbReadTable()`](https://dbi.r-dbi.org/reference/dbReadTable.md),
  [`dbWriteTable()`](https://dbi.r-dbi.org/reference/dbWriteTable.md),
...
- Schema support: Export
  [`Id()`](https://dbi.r-dbi.org/reference/Id.md), new generics
...
- The default implementation of
  [`dbReadTable()`](https://dbi.r-dbi.org/reference/dbReadTable.md) now
  has `row.names = FALSE` as default and also supports
  `row.names = NULL` ([\#186](https://github.com/r-dbi/DBI/issues/186)).

### API changes

- The [`SQL()`](https://dbi.r-dbi.org/reference/SQL.md) function gains
  an optional `names` argument which can be used to assign names to SQL
  strings.
...
- Fix [`dbDataType()`](https://dbi.r-dbi.org/reference/dbDataType.md)
...
- The default implementation of
  [`dbGetQuery()`](https://dbi.r-dbi.org/reference/dbGetQuery.md) now
  accepts an `n` argument and forwards it to
  [`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md). No warning
  about pending rows is issued anymore
...
- Fix [`dbReadTable()`](https://dbi.r-dbi.org/reference/dbReadTable.md)
...
- Interface changes
  - Deprecated
    [`dbDriver()`](https://dbi.r-dbi.org/reference/dbDriver.md) and
    [`dbUnloadDriver()`](https://dbi.r-dbi.org/reference/dbDriver.md) by
    documentation ([\#21](https://github.com/r-dbi/DBI/issues/21)).
  - Renamed arguments to
    [`sqlInterpolate()`](https://dbi.r-dbi.org/reference/sqlInterpolate.md)
    and
    [`sqlParseVariables()`](https://dbi.r-dbi.org/reference/sqlParseVariables.md)
...
- Interface enhancements
  ...
  - Removed [`tryCatch()`](https://rdrr.io/r/base/conditions.html) call
    in [`dbGetQuery()`](https://dbi.r-dbi.org/reference/dbGetQuery.md)
...
- Documentation improvements
  ...
  - Improved [`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md)
...
- Interface changes
  - [`dbDataType()`](https://dbi.r-dbi.org/reference/dbDataType.md) maps
    `character` values to `"TEXT"` by default
...
- Interface enhancements
  - New
    [`dbSendStatement()`](https://dbi.r-dbi.org/reference/dbSendStatement.md)
    generic, forwards to
    [`dbSendQuery()`](https://dbi.r-dbi.org/reference/dbSendQuery.md) by
    default ([\#20](https://github.com/r-dbi/DBI/issues/20),
    [\#132](https://github.com/r-dbi/DBI/issues/132)).
  - New [`dbExecute()`](https://dbi.r-dbi.org/reference/dbExecute.md),
    calls
    [`dbSendStatement()`](https://dbi.r-dbi.org/reference/dbSendStatement.md)
  ...
  - New
    ...
    [`dbRollback()`](https://dbi.r-dbi.org/reference/transactions.md) on
    failure ([\#110](https://github.com/r-dbi/DBI/issues/110),
    [@bborgesr](https://github.com/bborgesr)).
  - New
  ...
  - Export [`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) and
    [`dbQuoteString()`](https://dbi.r-dbi.org/reference/dbQuoteString.md)
    methods.
- Documentation improvements:
...
- The default [`show()`](https://rdrr.io/r/methods/show.html)
  ...
  [`dbIsValid()`](https://dbi.r-dbi.org/reference/dbIsValid.md) or the
  other methods used.
...
- [`dbGetInfo()`](https://dbi.r-dbi.org/reference/dbGetInfo.md) gains a
  default method that extracts the information from
  ...
  [`dbGetInfo()`](https://dbi.r-dbi.org/reference/dbGetInfo.md) (which
  may be deprecated anyway at some point)
  ([\#55](https://github.com/r-dbi/DBI/issues/55)).

- [`dbDataType()`](https://dbi.r-dbi.org/reference/dbDataType.md) and
  [`dbQuoteString()`](https://dbi.r-dbi.org/reference/dbQuoteString.md)
...
- Default
  [`dbGetQuery()`](https://dbi.r-dbi.org/reference/dbGetQuery.md) method
  now always calls
  [`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md), in a
  [`tryCatch()`](https://rdrr.io/r/base/conditions.html) block.

- New generic [`dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md)
...
- DBI gains a number of SQL generation functions. These make it easier
  ...
  - [`sqlData()`](https://dbi.r-dbi.org/reference/sqlData.md) is a new
    generic that converts a data frame into a data frame suitable for
    sending to the database. This is used to (e.g.) ensure all character
    vectors are encoded as UTF-8, or to convert R varible types (like
    factor) to types supported by the database.

  - The
    [`sqlParseVariablesImpl()`](https://dbi.r-dbi.org/reference/sqlParseVariables.md)
...
- New concrete `ANSIConnection` class and
  [`ANSI()`](https://dbi.r-dbi.org/reference/ANSI.md) function to
...
- [`dbGetQuery()`](https://dbi.r-dbi.org/reference/dbGetQuery.md) uses
  [`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) in the
...
- [`dbIsValid()`](https://dbi.r-dbi.org/reference/dbIsValid.md) returns
  a logical value describing whether a connection or result set (or
  other object) is still valid.
...
- [`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) added as
  alias to [`fetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) to
  provide consistent name. Implementers should define methods for both
  [`fetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) and
  [`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) until
  [`fetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) is deprecated
  in 2015. For now, the default method for
  [`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) calls
  [`fetch()`](https://dbi.r-dbi.org/reference/dbFetch.md).

- [`dbBegin()`](https://dbi.r-dbi.org/reference/transactions.md) begins
  a transaction ([\#17](https://github.com/r-dbi/DBI/issues/17)). If not
  supported, DB specific methods should throw an error (as should
  [`dbCommit()`](https://dbi.r-dbi.org/reference/transactions.md) and
...
- [`dbGetStatement()`](https://dbi.r-dbi.org/reference/dbGetStatement.md),
  ...
  [`dbGetInfo()`](https://dbi.r-dbi.org/reference/dbGetInfo.md). This
  means that most drivers should no longer need to implement these
  methods ([\#13](https://github.com/r-dbi/DBI/issues/13)).

- [`dbGetQuery()`](https://dbi.r-dbi.org/reference/dbGetQuery.md) gains
  a default method for `DBIConnection` which uses
  [`dbSendQuery()`](https://dbi.r-dbi.org/reference/dbSendQuery.md),
  [`fetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) and
...
- The following functions are soft-deprecated. They are going away, and
  ...
  - [`fetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) is replaced
    by [`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md).

  - [`make.db.names()`](https://dbi.r-dbi.org/reference/make.db.names.md),
    [`isSQLKeyword()`](https://dbi.r-dbi.org/reference/make.db.names.md)
    and
    [`SQLKeywords()`](https://dbi.r-dbi.org/reference/make.db.names.md):
...
- [`dbGetDBIVersion()`](https://dbi.r-dbi.org/reference/dbGetDBIVersion.md)
  is deprecated since it’s now just a thin wrapper around
  `packageVersion("DBI")`.

- [`dbSetDataMappings()`](https://dbi.r-dbi.org/reference/dbSetDataMappings.md)
  ([\#9](https://github.com/r-dbi/DBI/issues/9)) and
  [`dbCallProc()`](https://dbi.r-dbi.org/reference/dbCallProc.md)
...
- [`dbDriver()`](https://dbi.r-dbi.org/reference/dbDriver.md) gains a
  more effective search mechanism that doesn’t rely on packages being
