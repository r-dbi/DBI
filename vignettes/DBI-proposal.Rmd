...
(see [the Unix ODBC](http://genix.net/unixODBC) web-site and @odbc.lj).
...
The latest documentation and software on the RS-DBI is available at
[www.omegahat.org](http://www.omegahat.org/contrib/RS-DBI/index.html).
The R community has developed interfaces to some databases:
[RmSQL](http://cran.r-project.org/src/contrib/PACKAGES.html) is an
...
[RMySQL/SMySQL](http://www.omegahat.org/contrib/RS-DBI)@RS-MySQL to
[MySQL](http://www.mysql.org) that follow the propose RS-DBI API
described here; also, there’s an S-Plus interface
[SOracle](http://www.omegahat.org/contrib/RS-DBI)@RS-Oracle to
...
([www.genix.net/unixODBC](http://www.genix.net/unixODBC)), in Python’s
