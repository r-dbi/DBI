...
For a more complete list of supported DBMS visit [https://github.com/r-dbi/backends#readme](https://github.com/r-dbi/backends).
...
In the example username, password, host, port, dbname are required.
