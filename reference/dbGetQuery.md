...
calls [`dbSendQuery()`](https://dbi.r-dbi.org/reference/dbSendQuery.md),
then [`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md), ensuring
that the result is always freed by
