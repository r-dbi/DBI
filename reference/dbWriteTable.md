...
- name:
  ...
  - a call to [`Id()`](https://dbi.r-dbi.org/reference/Id.md) with
    components to the fully qualified table name, e.g.
    `Id(schema = "my_schema", table = "table_name")`

  - a call to [`SQL()`](https://dbi.r-dbi.org/reference/SQL.md) with the
    quoted and fully qualified table name given verbatim, e.g.
...
[`DBI::dbQuoteIdentifier()`](https://dbi.r-dbi.org/reference/dbQuoteIdentifier.md)
...
identically with
[`DBI::dbReadTable()`](https://dbi.r-dbi.org/reference/dbReadTable.md):
...
[`DBI::dbDataType()`](https://dbi.r-dbi.org/reference/dbDataType.md).

The interpretation of
[rownames](https://dbi.r-dbi.org/reference/rownames.md) depends on the
`row.names` argument, see
[`DBI::sqlRownamesToColumn()`](https://dbi.r-dbi.org/reference/rownames.md)
for details:
