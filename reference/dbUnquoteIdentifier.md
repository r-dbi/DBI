...
[SQL](https://dbi.r-dbi.org/reference/SQL.md) object created by
[`dbQuoteIdentifier()`](https://dbi.r-dbi.org/reference/dbQuoteIdentifier.md)
back to a list of [Id](https://dbi.r-dbi.org/reference/Id.md) objects.
...
- x:
  ...
  An [SQL](https://dbi.r-dbi.org/reference/SQL.md) or
  [Id](https://dbi.r-dbi.org/reference/Id.md) object.
...
[DBI::Id](https://dbi.r-dbi.org/reference/Id.md), calling
`dbUnquoteIdentifier(..., x)` returns `list(x)`. (For backends it may be
most convenient to return
[DBI::Id](https://dbi.r-dbi.org/reference/Id.md) objects to achieve this
behavior, but this is not required.)
...
[`DBI::SQL()`](https://dbi.r-dbi.org/reference/SQL.md) and then quoting
via
[`DBI::dbQuoteIdentifier()`](https://dbi.r-dbi.org/reference/dbQuoteIdentifier.md)
