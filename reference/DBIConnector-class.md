...
[DBIDriver](https://dbi.r-dbi.org/reference/DBIDriver-class.md) class to
include connection options. The purpose of this class is to store both
the driver and the connection options. A database connection can be
established with a call to
[`dbConnect()`](https://dbi.r-dbi.org/reference/dbConnect.md), passing
only that object without additional arguments.
