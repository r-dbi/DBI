...
- x:
  ...
  A character vector, [SQL](https://dbi.r-dbi.org/reference/SQL.md) or
  [Id](https://dbi.r-dbi.org/reference/Id.md) object to quote as
  identifier.
...
[DBI::SQL](https://dbi.r-dbi.org/reference/SQL.md) should also return
them unchanged. (For backends it may be most convenient to return
[DBI::SQL](https://dbi.r-dbi.org/reference/SQL.md) objects to achieve
...
Calling
[`DBI::dbGetQuery()`](https://dbi.r-dbi.org/reference/dbGetQuery.md) for
