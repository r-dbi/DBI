...
added with
[`DBI::dbWriteTable()`](https://dbi.r-dbi.org/reference/dbWriteTable.md)
...
from
[`DBI::dbListTables()`](https://dbi.r-dbi.org/reference/dbListTables.md),

The `table` object can be quoted with
[`DBI::dbQuoteIdentifier()`](https://dbi.r-dbi.org/reference/dbQuoteIdentifier.md).
The result of quoting can be passed to
[`DBI::dbUnquoteIdentifier()`](https://dbi.r-dbi.org/reference/dbUnquoteIdentifier.md).
(For backends it may be convenient to use the
[DBI::Id](https://dbi.r-dbi.org/reference/Id.md) class, but this is not
required.)
...
call to
[`DBI::dbExistsTable()`](https://dbi.r-dbi.org/reference/dbExistsTable.md)
which returns `TRUE`.
