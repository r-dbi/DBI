...
values are passed to `dbBind()` as lists or data frames, and to
...
or
[`DBI::dbSendQueryArrow()`](https://dbi.r-dbi.org/reference/dbSendQueryArrow.md)
...
1.  Use
    ...
    create a result set object of class
    [DBIResult](https://dbi.r-dbi.org/reference/DBIResult-class.md).
...
1.  Use
    ...
    [DBIResultArrow](https://dbi.r-dbi.org/reference/DBIResultArrow-class.md).
...
1.  Use
    [`dbSendStatement()`](https://dbi.r-dbi.org/reference/dbSendStatement.md)
    to create a result set object of class
    [DBIResult](https://dbi.r-dbi.org/reference/DBIResult-class.md). For
    some queries you need to pass `immediate = TRUE`.
...
1.  Call
    ...
    - [`DBI::dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md)
      raises an error (for
      [`dbSendQuery()`](https://dbi.r-dbi.org/reference/dbSendQuery.md)
      and
      [`dbSendQueryArrow()`](https://dbi.r-dbi.org/reference/dbSendQueryArrow.md))
    ...
    - [`DBI::dbIsValid()`](https://dbi.r-dbi.org/reference/dbIsValid.md)
      returns `TRUE`
