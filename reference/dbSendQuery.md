...
[`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) method, and
then you must call
...
[`DBI::dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.md) to
...
[`DBI::dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md) for
details.
...
2.  DBI backend defaults to `immediate = FALSE` internally
    ...
    2.  A query with parameters is passed:
        ...
        1.  `params` not given: waiting for parameters via
            [`DBI::dbBind()`](https://dbi.r-dbi.org/reference/dbBind.md)
